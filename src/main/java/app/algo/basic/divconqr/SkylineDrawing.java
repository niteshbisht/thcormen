 ...
 *
 * @author Tushar Roy
 *     <p>Given skyline of a city merge the buildings
 *     <p>Time complexity is O(nlogn) Space complexity is O(n)
 *     <p>References https://leetcode.com/problems/the-skyline-problem/
...
public class SkylineDrawing {
  ...
  public List<int[]> getSkyline(int[][] buildings) {
    ...
    for (BuildingPoint buildingPoint : buildingPoints) {
      // if it is start of building then add the height to map. If height already exists then
      // increment
      // the value
